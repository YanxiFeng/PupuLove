...
-(UIImage*) thumbnailImage:(CGSize) thumbnailSize interpolationQuality:(CGInterpolationQuality)quality{
    UIImage *resizedImage = [self resizedImageWithContentMode:UIViewContentModeScaleAspectFill
...
- (UIImage *)resizedImage:(CGSize)newSize
	...
	//NSLog(@"CGImageGetBitmapInfo: %d = %d", CGImageGetBitmapInfo(imageRef), kCGImageAlphaNoneSkipLast);
    ...
    CGContextRef bitmap = CGBitmapContextCreate(NULL,
                                                ...
                                                1//kCGImageAlphaNoneSkipLast//CGImageGetBitmapInfo(imageRef)
												);
